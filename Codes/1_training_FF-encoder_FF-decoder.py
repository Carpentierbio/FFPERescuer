...
# Convolutional FF-encoder and FF-decoder
...
# Train FF-encoder and FF-decoder
...
# save model
save_model(parallel_conv_autoencoder_model,'./models/FF_autoencoder.h5')   
save_model(encoder,'./models/FF_encoder.h5')   
save_model(decoder,'./models/FF_decoder.h5')
