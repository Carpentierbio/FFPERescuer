...
# Load training Data
rnaseq_file = os.path.join('./data/FF_TCGA_gene_expression_9568samples_1024genes_for_AMC_FFPE_CRC.csv')
...
loaded_encoder = load_model("./models/FF_encoder.h5")
...
save_model(parallel_sec_net_model, './models/Partial_FF_encoder.h5')
